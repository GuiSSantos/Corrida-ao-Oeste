...
void Menu::setPosition(float dx,float dy)
{
    ...
    menu[0].setPosition(sf::Vector2f(dx+100, dy-400));
    menu[1].setPosition(sf::Vector2f(dx+100, dy-300));
    menu[2].setPosition(sf::Vector2f(dx+100, dy-200));
    menu[3].setPosition(sf::Vector2f(dx+100, dy-100));
    menu[4].setPosition(sf::Vector2f(dx+100, dy));
