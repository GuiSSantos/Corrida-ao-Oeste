...
Fase1::Fase1()
{
    ...
    plataformas.push_back(Plataforma(&chao,Vector2f(400.f,50.f),Vector2f(3780.f,-240.f)));
    plataformas.push_back(Plataforma(&chao,Vector2f(100.f,50.f),Vector2f(4200.f,-240.f)));
    plataformas.push_back(Plataforma(&chao,Vector2f(100.f,50.f),Vector2f(4400.f,-200.f)));
    plataformas.push_back(Plataforma(&chao,Vector2f(1000.f,450.f),Vector2f(5100.f,200.f)));
    ...
    obs.push_back((Obstaculo*)new BolaFeno(&bola,Vector2f(30.f,30.f),Vector2f(3800.f,-290.f)));
    obs.push_back((Obstaculo*)new Tnt(&tnt,Vector2f(30.f,30.f),Vector2f(1170.f,-215.f)));

    inimigos.push_back((Inimigo*)new Apache(&cacto,Vector2f(3600.f,-290.f),0.1f));
    inimigos.push_back((Inimigo*)new Apache(&cacto,Vector2f(4620.f,-330.f),0.1f));

    inimigos.push_back((Inimigo*)new JJ(&jj,Vector2f(750.f,-170.f),0.1f));
...
void Fase1::Executar(RenderWindow& window,float deltaTime, Jogador& jogador1,View& view){
    ...
    sprite.setPosition(-250.f,-1100.f);
...
void Fase1::Executar2(RenderWindow& window,float deltaTime, Jogador2& jogador2){
    ...
    std::string aux ("vidas: ");
    std::stringstream aux2;
    aux2 << jogador2.getVida();
    aux += aux2.str();
    vidas.setString(aux);
    vidas.setFont(fonte);
    int antiga=jogador2.getVida();
    int caux=0;

    /*if(jogador2.GetAtira()==true){
        bala.push_back(Projetil(&bala1,Vector2f(10.0f,4.f),Vector2f(jogador2.GetPosition().x+22.f,jogador2.GetPosition().y-19.f),jogador2));
    }*/
  ...
  for(Plataforma& plataforma : plataformas){
    ...
    if (jogador2.getVida()!=antiga)
    {
        ...
        aux = aux2.str();
        vidas.setString(aux);
        antiga=jogador2.getVida();
    }

    vidas.setPosition(jogador2.GetPosition().x, jogador2.GetPosition().y-100);
